...
export default class MyPhotos extends Component {
  ...
  var pswpElement = document.querySelectorAll('.pswp')[0];
       ...
       var items = [
           {
               src: 'https://placekitten.com/60000/400',
               w: 600,
               h: 400,
               msrc: 'https://placekitten.com/600/400',
               title: 'Maronna Caption'
           },
           {
       ...
       <div>
               <div className="my-gallery" itemScope itemType="http://schema.org/ImageGallery">
                        ...
                        <figure itemProp="associatedMedia" itemScope itemType="http://schema.org/ImageObject">
                            <a href="minion2.jpg" itemProp="contentUrl" data-size="600x400">
                                <img src="minion.jpg" itemProp="thumbnail" alt="Image description" />
                            </a>
